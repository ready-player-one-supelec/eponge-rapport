...
\begin{equation}
 \mathbb{P}\left(X=x\right) = \begin{cases}q &\text{ si $x=1$}\\1-q &\text{ si $x=0$}\end{cases} \text{, \parbox[t]{15em}{où $X$ représente notre réseau\\
...
\begin{equation}
 \label{eq:ddp}
 \mathbb{P}\left(X=x\right) = q^x\left(1-q\right)^{1-x}
\end{equation}
...
\begin{align*}
 \mathbb{L}(x_1,x_2,...,x_N,q) &= q^{\sum_{i=1}^N x_i}\left(1-q\right)^{\sum_{i=1}^N \left(1-x_i\right)}\\
 &= q^{Np}\left(1-q\right)^{N\left(1-p\right)}  
 \label{eq:vraisemblance}
 \numberthis
\end{align*} 

\begin{equation}
 \frac{1}{N}\log\left(\mathbb{L}\left(x_1,x_2,...,x_N,q\right)\right) = p\ln\left(q\right) + \left(1-p\right)\ln\left(1-q\right) 
